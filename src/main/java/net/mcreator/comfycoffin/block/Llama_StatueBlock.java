...
public class Llama_StatueBlock extends ComfyCoffinElements.ModElement {
	@ObjectHolder("comfycoffin:llama_statue")
	public static final Block block = null;
	public Llama_StatueBlock(ComfyCoffinElements instance) {
		super(instance, 60);
	}
