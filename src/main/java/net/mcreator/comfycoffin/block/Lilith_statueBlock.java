...
public class Lilith_statueBlock extends ComfyCoffinElements.ModElement {
	@ObjectHolder("comfycoffin:lilith_statue")
	public static final Block block = null;
	public Lilith_statueBlock(ComfyCoffinElements instance) {
		super(instance, 39);
	}
