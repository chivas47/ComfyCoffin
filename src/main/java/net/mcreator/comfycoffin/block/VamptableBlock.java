...
public class VamptableBlock extends ComfyCoffinElements.ModElement {
	@ObjectHolder("comfycoffin:vamptable")
	public static final Block block = null;
	public VamptableBlock(ComfyCoffinElements instance) {
		super(instance, 18);
	}
