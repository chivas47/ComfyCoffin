...
public class PiglinstatueBlock extends ComfyCoffinElements.ModElement {
	@ObjectHolder("comfycoffin:piglinstatue")
	public static final Block block = null;
	public PiglinstatueBlock(ComfyCoffinElements instance) {
		super(instance, 55);
	}
