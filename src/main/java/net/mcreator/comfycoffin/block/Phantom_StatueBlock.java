...
public class Phantom_StatueBlock extends ComfyCoffinElements.ModElement {
	@ObjectHolder("comfycoffin:phantom_statue")
	public static final Block block = null;
	public Phantom_StatueBlock(ComfyCoffinElements instance) {
		super(instance, 59);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("phantom_statue");
		}
