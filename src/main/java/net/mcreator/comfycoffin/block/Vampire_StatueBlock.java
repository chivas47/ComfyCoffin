...
public class Vampire_StatueBlock extends ComfyCoffinElements.ModElement {
	@ObjectHolder("comfycoffin:vampire_statue")
	public static final Block block = null;
	public Vampire_StatueBlock(ComfyCoffinElements instance) {
		super(instance, 42);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("vampire_statue");
		}
